(function ($, once) {
  Drupal.behaviors.betterExposedFiltersSelectAllNone = {
    attach: function () {
      ...
      if (selected.length) {
        const selAll = Drupal.t('All');
        const selNone = Drupal.t('All');
        ...
        link.click(function (event) {
          ...
          // Use classes to determine state instead of link text so both labels can be "All".
          if ($(this).hasClass('bef-toggle--select-all')) {
